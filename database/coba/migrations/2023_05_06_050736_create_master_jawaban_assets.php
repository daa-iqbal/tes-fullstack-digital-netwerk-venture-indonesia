...
class CreateMasterJawabanAssets extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('master_jawaban_assets', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('master_jawaban_assets');
    }
}
